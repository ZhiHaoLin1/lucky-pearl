...
const gameData: Record<string, {
  ...
  'ultra-thunder': {
    ...
    description: 'Storm clouds gather over an electrified sky arena where the Thunder God tests every challenger.',
    longDescription: 'High above the clouds, the Thunder God channels raw electricity into a storm arena built for bold challengers. Ultra Thunder is a fast-paced 5x4 slot where Thunder Wilds strike down at random, electrifying entire columns and chaining bolts of lightning into consecutive wins. When the storm reaches full charge, the Storm Free Spins mode unleashes 12 free games with a multiplier that climbs with every bolt that lands.',
    rtp: '96.4%',
    minBet: '$0.20',
    maxBet: '$600',
    volatility: 'High',
    ...
    accentColor: '#60a5fa',
    features: [
      { title: 'Thunder Wild Strike', description: 'Lightning bolts strike random columns, turning every symbol they touch into a wild.', icon: '⚡' },
      { title: 'Storm Free Spins', description: '12 free games triggered by 3+ storm cloud scatters, with a multiplier that climbs on every strike.', icon: '🌩️' },
      { title: 'Chain Lightning Multiplier', description: 'Consecutive Thunder Wild strikes chain together, multiplying the total win up to 25x.', icon: '🔗' },
      { title: 'Overcharge Jackpot', description: 'Fill the storm meter with 8 charged spins to unleash the Overcharge grand jackpot.', icon: '👑' },
    ],
    howToPlay: [
      'Choose your bet amount from $0.20 to $600 per spin',
      'Watch the skies — Thunder Wilds strike columns at random',
      'Match symbols across 1,024 ways on the 5x4 grid',
      'Land 3 Storm Cloud scatters to trigger Storm Free Spins',
      'Chain multiple lightning strikes together for maximum payouts',
    ],
  },
  'dragon-fury': {
    name: 'Dragon Fury',
    ...
    description: 'A raging dragon tears through a shattered sky, its fury igniting every reel it crosses.',
    longDescription: 'Where Golden Dragon rewards patience, Dragon Fury rewards nerve. A raging dragon tears across a shattered sky, and every spin builds its Rage Meter higher. Wild storms sweep the reels as the meter climbs, and once fully charged, the dragon unleashes a Fury Free Spins round with relentless, ever-growing multipliers. This is our most volatile game — built for players chasing the biggest possible swing.',
    rtp: '95.9%',
    minBet: '$0.25',
    maxBet: '$750',
    volatility: 'Very High',
    ...
    accentColor: '#a855f7',
    features: [
      { title: 'Rage Meter Wild', description: 'Every spin fills the Rage Meter — once full, a full-reel wild storm sweeps across the grid.', icon: '😡' },
      { title: 'Fury Free Spins', description: '10 free games with a multiplier that grows every time the dragon strikes, never resetting.', icon: '🔥' },
      { title: 'Shattered Sky Jackpot', description: 'Trigger the jackpot by filling the Rage Meter three times in a single session.', icon: '🏆' },
      { title: 'Cascade Mechanic', description: 'Winning symbols shatter and cascade away, giving a single spin the chance to chain dozens of wins.', icon: '💫' },
    ],
    howToPlay: [
      'Bet between $0.25 and $750 — this is our highest-volatility game',
      'Wins pay across 3,125 ways on the 5x5 cascading grid',
      'Every spin fills the Rage Meter, win or lose',
      'A full Rage Meter unleashes a full-reel wild storm',
      'Fill the meter 3 times in one session to trigger the Shattered Sky Jackpot',
    ],
  },
};
